...
* [Example 1](example-jobs/example1Jobs.groovy) - shows basic folder/job creation
* [Example 2](example-jobs/example2Jobs.groovy) - shows how to create a set of jobs for each github branch, each in its own folder
* [Example 3](example-jobs/example3Jobs.groovy) - shows how to use the configure block
* [Example 4](example-jobs/example4Jobs.groovy) - shows a way to reuse job definitions for jobs that differ only with a few properties
* [Example 5](example-jobs/example5Jobs.groovy) - shows how to pull out common components into static methods
* [Example 6](example-jobs/example6Jobs.groovy) - shows how to include script resources from the workspace
* [Example 7](example-jobs/example7Jobs.groovy) - shows how to create jobs using builders
* [Example 8](example-jobs/example8Jobs.groovy) - shows how to use DSL extensions provided by other plugins
